...
export function buildStructuredData(context, coverage) {
...
export function buildSocialCardSvg(context, report) {
...
export function buildRobotsTxt(context) {
  return `User-agent: *
Allow: /
...
export function buildSitemap(context) {
  return `<?xml version="1.0" encoding="UTF-8"?>
...
export function buildWebManifest(context) {
  return `${JSON.stringify(
    {
      name: "Pixel Flags",
